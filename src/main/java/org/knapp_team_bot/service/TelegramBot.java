...
import org.knapp_team_bot.config.BotConfig;
...
public class TelegramBot extends TelegramLongPollingBot {
    ...
    static final String HELP_TEXT = "Натисніть /start , щоб почати роботу зі мною\n\n" +
            "Натисніть /help , щоб побачити корисні поради\n\n" +
            "Натисніть /info , щоб побачити інформацію про бота \n\n" +
            "Натисніть /newpetition , щоб написати нову петицію";
    static final String INFOTEXT = "Бот створений для подання петиції учнівському самоврядуванню Черкаської Спеціалізованої школи I-III ступенів №17.";
